...
<head>
    ...
    <!-- Modern Elegant Font -->
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&family=Playfair+Display:ital,wght@0,600;1,600&display=swap%22 rel="stylesheet">
...
<body class="antialiased">
    ...
    <header class="container mx-auto px-4 py-8 flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center space-x-8 text-gray-600">
            ...
            <a href="{{ route('admin.login') }}" class="flex flex-col items-center hover:text-primary transition-all hover:scale-102" title="Admin Login">
