...
<div class="data-table">
    <div style="padding:20px 24px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,0.05);">
        <div class="font-serif-elegant text-xl font-bold" style="color:var(--primary);">All Orders</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="vertical-align:top;">
                    <div style="font-weight:600;">AED {{ number_format($order->total_amount, 2) }}</div>
                ...
                <td style="vertical-align:top;width:300px;">
                    <form method="POST" action="{{ route('admin.orders.update', $order->id) }}" style="display:flex;flex-direction:column;gap:8px;">
                        ...
                        <div style="display:flex;gap:8px;">
                            ...
                            <select name="delivery_boy_id" class="form-control" style="flex:1;padding:6px 10px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:0.8rem;color:var(--text-dark);background:var(--bg-darker);">
